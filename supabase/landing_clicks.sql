...
-- Events recorded: hero_try_demo, hero_see_founding_access, nav_try_demo,
-- demo_open_demo, pricing_buy_founding_access, pricing_try_demo_first,
-- bottom_buy_founding_access, bottom_try_demo_first.
